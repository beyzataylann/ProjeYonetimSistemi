            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="http://localhost/ProjeYonetimSistemi/proje/proje_ekle.html">
                                Proje Ekle
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/ProjeYonetimSistemi/proje/calisan_ekle.html">
                                Çalışan Ekle
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost/ProjeYonetimSistemi/proje/calisan_sil.html">
                                Çalışan Sil
                            </a>
                        </li>
